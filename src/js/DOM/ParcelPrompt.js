...
export default function ParcelPrompt() {
	const changeParcelTotal = useGlobalState((state) => state.changeParcelTotal)
	const initialPrompt = useGlobalState((state) => state.initialPrompt)
	const setInitialPrompt = useGlobalState((state) => state.setInitialPrompt)
